...
def main():
    ...
    parser.add_argument("--input", default="persona_1000000.jsonl", help="Input JSONL file")
    ...
    parser.add_argument("--n_select", type=int, default=1000, help="Number of personas to select")
    ...
    if not input_path.exists():
        input_path = Path("/Users/xinyu/Downloads/DA-FPS") / args.input

    output_dir = input_path.parent
    dedup_output = output_dir / "persona_deduplicated.jsonl"
    final_output = output_dir / "persona_selected_1000.jsonl"
    embeddings_cache = output_dir / args.embeddings_cache
