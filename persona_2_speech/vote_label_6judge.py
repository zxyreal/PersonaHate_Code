...
def add_llamaguard_judge(args):
    ...
    for name, dirname in model_dirs.items():
        labeled_file = SPEECH_DIR / dirname / "persona_selected_2285_fps_stratified_speech_labeled_6judge.jsonl"
...
def main():
    ...
    for name, dirname in model_dirs.items():
        ...
        output_file = SPEECH_DIR / dirname / "persona_selected_2285_fps_stratified_speech_labeled_6judge.jsonl"
        print(f"\n{'='*60}")
